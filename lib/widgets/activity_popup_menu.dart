...
import 'package:sc_app/modals/delete_activity.dart';
import 'package:sc_app/modals/reschedule_activity.dart';
import 'package:sc_app/modals/edit_activity.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PopupMenuButton<int>(
      ...
      itemBuilder: (context) => [
        PopupMenuItem(
          value: 1,
          child: (activity.description == null)
              ? null
              : popupMenuTile(
